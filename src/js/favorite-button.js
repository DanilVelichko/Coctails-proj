...
e.target.innerHTML = `<div class="box__addTo__remove"> Remove <svg width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="coctailsId visually-hidden">${element}</div></div>`;
                ...
                e.target.innerHTML = `<div class="box__addTo__remove"> Add to <svg width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
